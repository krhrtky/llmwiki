...
| [016](./016-finalize-access-policy-evaluation.md) | Accepted | access policy の評価順序を `deny > hold > allow` に固定する |
...
| [019](./019-do-not-add-private-scope.md) | Superseded by [023](./023-use-storage-registry-for-visibility-boundaries.md) | `private` scope は追加せず、個人/private 相当は `personal` と access policy で扱う |
