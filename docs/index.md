...
6. [milestones.md](./milestones.md) で milestone の完了証跡を確認する。
7. [specs/](./specs/index.md) で milestone ごとの具体仕様を確認する。
8. [handoff-next-session.md](./handoff-next-session.md) で直近実装 slice と残作業を確認する。
...
- milestone の完了条件と証跡は [milestones.md](./milestones.md) に集約する。
- format、CLI/API、workflow/access、maintenance の具体仕様は [specs/](./specs/index.md) に置く。
- 直近セッションの引き継ぎは [handoff-next-session.md](./handoff-next-session.md) に置く。
