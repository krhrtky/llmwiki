...
5. [milestones.md](./milestones.md) で milestone の完了証跡を確認する。
6. [specs/](./specs/index.md) で milestone ごとの具体仕様を確認する。
...
- 判断材料の出典は [references/index.md](./references/index.md) に集約するが、SoT 本文ではない。
